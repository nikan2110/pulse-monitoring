...
public class DataProviderClient {
	...
	DoctorPatientData getData(int id) {
		ResponseEntity<DoctorPatientData> response = restTemplate.exchange(dataProviderServiceHost + DOCTOR_PATIENT_DATA_URL + "/" + id, HttpMethod.GET,
				null, DoctorPatientData.class);
